...
#   for (marker in markers) {
#     # Check if the marker exists in the data before processing
#     if (!marker %in% available_genes) {
#       cat(sprintf("⚠️ Marker %s not found in the data, skipping individual and combined plot for this marker...\n", marker))
#       next
#     }
    
#     # Extract expression data (safe to proceed since marker exists)
...
# # Debug: Print available gene names to help diagnose missing markers
# cat("📋 Available gene names in the dataset (first 50 shown):\n")
# print(head(rownames(GetAssayData(integrated_data, assay = "RNA", slot = "data")), 50))